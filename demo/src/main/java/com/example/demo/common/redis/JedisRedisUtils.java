...
public class JedisRedisUtils {
    ...
    private static final Logger logger = LogManager.getLogger(JedisRedisUtils.class);
    ...
    public static boolean save(Object key, Object object, int seconds) {
        logger.debug("jedis保存数据：{}{}{}", key, object, seconds);
        Jedis jedis = null;
        try {
            jedis = jedisSentinelPool.getResource();
    ...
    public void setJedisSentinelPool(JedisSentinelPool jedisSentinelPool) {
        JedisRedisUtils.jedisSentinelPool = jedisSentinelPool;
    }
