...
//消费者
public class subjiaohuanji2 {
    public static final  String QUEUE_NAME="test_exchange_queue_email_dircet2";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //绑定交换机 多个key
        channel.queueBind(QUEUE_NAME,EXCHEGE_NAME,"info");
        //绑定交换机 多个key
        channel.queueBind(QUEUE_NAME,EXCHEGE_NAME,"warning");
